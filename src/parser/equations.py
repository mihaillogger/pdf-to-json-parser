...
class EquationExtractor:
    ...
    def _clean_latex(self, raw_latex: str) -> str:
        ...
        cleaned = re.sub(r'(?:~|\\quad|\\qquad|\\ |\\!|\\,)+(\(\d+\)|\\tag\{\d+\})$', r' \1', raw_latex)
    ...
    def process_pdf(self, pdf_path: str) -> List[Equation]:
        ...
        with fitz.open(pdf_path) as doc:
            for page_num in range(len(doc)):
                ...
                yolo_res = self.model.predict(page_img, imgsz=1024, conf=0.5, verbose=False)
                ...
                for box in sorted_boxes:
                    ...
                    if self.math_ocr:
                        try:
                            ...
                            logger.error("Ошибка Pix2Tex на странице %d: %s", page_num + 1, e)
